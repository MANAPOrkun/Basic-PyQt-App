...
class register_form(object):
    def setupUi(self, Form):
        ...
        self.input_fileds_frame.setGeometry(QtCore.QRect(210, 30, 541, 581))
        ...
        self.pushButton.clicked.connect(lambda: self.register(Form))
    ...
    def register(self, Form):
        ...
        result = database.read(email, db)

        if len(result.fetchall()) <= 0:
            database.insert(name, email, password, phone, db)
            self.ui = login_form()
